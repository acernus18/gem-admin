...
public class ConstUtils {
    public static String[] get(String key) {
        ...
        configuration.put("无烧艳蓝", new String[]{"H无烧粉红蓝宝石", "EE艳粉色"});
        ...
        configuration.put("无烧黄", new String[]{"I无烧黄色蓝宝石", "H黄色"});
        ...
        configuration.put("紫色", new String[]{"QQ紫色蓝宝石", "F紫色"});
        configuration.put("艳紫", new String[]{"QQ紫色蓝宝石", "FF艳紫色"});
        ...
        configuration.put("星光红", new String[]{"Y星光红宝石", "A红色"});
        configuration.put("星光蓝", new String[]{"Z星光蓝宝石", "B蓝色"});
        configuration.put("无烧橙", new String[]{"Z无烧橙色蓝宝石", "n橙色"});
        configuration.put("无烧变色蓝宝", new String[]{"无烧变色蓝宝石", "B蓝色"});
